...
If your tasks are about email, there are some information you should know:
...
if not args.query:
    ...
    #args.query = "try to send an email to Jack. His email is canmoweiliang@gmail.com, and you can say anything in this email."
    args.query = "Check if there are any unread emails in my email, and if so, mark them as read."
